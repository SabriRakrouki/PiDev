...
public class InvitationServiceImpl implements IInvitationService{
	...
	public List<Invitation> ReadDataFromExcel(String excelPath) throws EncryptedDocumentException, InvalidFormatException, IOException, MessagingException{
		String username;
 ...
 public void sendEmail(Invitation inv) throws MessagingException, UnsupportedEncodingException {
     ...
     Entreprise entreprise = inv.getEntreprise();
      String link ="http://localhost:8091/signup/employee";
     String subject = "Join the TRAVELUP community";  
     String content = "<p>Hello everybody,</p>"
             + "<p>The " + entreprise.getName()+ " company invites you "
             + "to create an account on the TRAVELUP platform.</p>"
             + "<p>you find the direct link below:</p>"
